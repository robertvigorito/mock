...
PACKAGE			= mock
VERSION 		= 0.0.1-rc.1
DESCRIPTION 	= Mock package for development testing purpose
...
PYTHON.ROOT = ./python
PYTHON.FILES = $(shell find $(PYTHON.ROOT) -type f -name "*.py")
...
RESOURCES.FILES = $(shell find $(SCRIPTS.ROOT) -type f -name "*")
